...
@save "/home/arnab22/SPF-data/hexabenzocoronene/sto3g/tpsci/est_basis/tpsci_nbody0/delta_elec1/tpsci_tucker_nbody0_deltaelec1.jl.scr/clip/tucker_clip_0.0004.jld2" clusters cluster_bases e0 v11 e2 ecore s2
...
@printf(" %5s %12.8f %12.8f %12.8f\n",1, e0[1]+ecore,e2[1]+ecore, abs(s2[1]))
@save "/home/arnab22/SPF-data/hexabenzocoronene/sto3g/tpsci/est_basis/tpsci_nbody0/delta_elec1/tpsci_tucker_nbody0_deltaelec1.jl.scr/clip/tucker_clip_0.0006.jld2" clusters cluster_bases e0 v2 e2 ecore s2
...
@printf(" %5s %12.8f %12.8f %12.8f\n",1, e0[1]+ecore,e2[1]+ecore, abs(s2[1]))
@save "/home/arnab22/SPF-data/hexabenzocoronene/sto3g/tpsci/est_basis/tpsci_nbody0/delta_elec1/tpsci_tucker_nbody0_deltaelec1.jl.scr/clip/tucker_clip_0.0008.jld2" clusters cluster_bases e0 v3 e2 ecore s2
...
@printf(" %5s %12.8f %12.8f %12.8f\n",1, e0[1]+ecore,e2[1]+ecore, abs(s2[1]))
@save "/home/arnab22/SPF-data/hexabenzocoronene/sto3g/tpsci/est_basis/tpsci_nbody0/delta_elec1/tpsci_tucker_nbody0_deltaelec1.jl.scr/clip/tucker_clip_0.001.jld2" clusters cluster_bases e0 v4 e2 ecore s2
