...
ecore = ints.h0
@load  "/home/nbraunsc/FermiCG-data/excited_paper/tt/tucker_thresh_0.0004.jld2"
...
@save "/home/nbraunsc/FermiCG-data/excited_paper/tt/tucker_clip_0.0006.jld2" clusters cluster_bases e0 v11 e2 ecore s2
println()
...
@save "/home/nbraunsc/FermiCG-data/excited_paper/tt/tucker_clip_0.0008.jld2" clusters cluster_bases e0 v2 e2 ecore s2
println()
println("  *======TPSCI results======*")
@printf("TCI Thresh: %8.6f  Dim:%8d\n",0.0008,size(v2)[1])
println()
